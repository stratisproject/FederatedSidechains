...
{
    /// <summary>
    /// The TransferMonitor examines transactions to detect deposit and withdrawal transactions.
    ...
    /// When an appropriate transaction is detected we create a transfer in our session manager and continue monitoring
    /// our chain.
    ...
    /// </summary>
    public interface ITransferSource : IDisposable
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="sourceBlock">The block received from the BlockObserver.</param>
        void ProcessBlock(Block sourceBlock);
    }
}

...
namespace Stratis.FederatedPeg.Features.FederationGateway.Interfaces
{
    ...
    public interface IOpReturnDataReader
    {
        ...
        /// </summary>
        /// <param name="transaction">The transaction we are examining.</param>
        /// <returns>The transaction id as a string, or null if nothing is found, or if multiple addresses are found.</returns>
        string TryGetTransactionIdFromOpReturn(Transaction transaction);
    }
}